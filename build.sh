...
std_respack "BreathOfTheWild_Shadows" "${res16by9[@]/$just720p}"
std_respack "Brunswick" "${res16by9[@]/$just720p}"
std_respack "CaptainToad" "${res16by9[@]/$just720p}" "${res21by9[@]}"
std_respack "CaptainToad_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "HyruleWarriors_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "MarioKart8_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "NewSuperMarioBrosU_Shadows" "${res16by9[@]/$just720p}"
std_respack "NinjaGaiden3RE" "${res16by9[@]/$just720p}"
std_respack "NintendoLand" "${res16by9[@]/$just720p}"
std_respack "NintendoLand_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "PokkenTournament_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "Splatoon_Shadows" "${res16by9[@]/$just720p}"
...
std_respack "SuperMario3DWorld_Shadows" "${res16by9[@]/$just720p}"
std_respack "SuperSmashBros" "${res16by9[@]/$just1080p}"
std_respack "SuperSmashBros_Shadows" "${res16by9[@]/$just1080p}"
...
std_respack "TwilightPrincessHD_Shadows" "${res16by9[@]/$just1080p}"
std_respack "WarriorsOrochi3" "${res16by9[@]/$just720p}"
std_respack "WindWakerHD" "${res16by9[@]/$just1080p}" "${res21by9[@]}"
std_respack "WindWakerHD_Shadows" "${res16by9[@]/$just1080p}"
...
std_respack "XenobladeX_Shadows" "${res16by9[@]/$just720p}"
echo -e "${NC}"
